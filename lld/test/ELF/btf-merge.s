...
# RUN: llvm-objdump -s -j .BTF.ext btfext | FileCheck %s --check-prefix=BTFEXT-HEX
...
# RUN: llvm-objdump -s -j .BTF.ext btfext-pass | FileCheck %s --check-prefix=BTFEXT-HEX

# HAS-BTFEXT:    .BTF.ext
# BTFEXT-HEX: Contents of section .BTF.ext:
# BTFEXT-HEX: 04000000
